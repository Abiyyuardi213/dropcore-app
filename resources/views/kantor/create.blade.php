                        ...
                        <form action="{{ route('kantor.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kantor"
                                    ...
                                    <option value="1" {{ old('jenis_kantor') == 1 ? 'selected' : '' }}>Pusat</option>
                                    <option value="2" {{ old('jenis_kantor') == 2 ? 'selected' : '' }}>Cabang</option>
                                    <option value="3" {{ old('jenis_kantor') == 3 ? 'selected' : '' }}>Gudang</option>
                                </select>
                                @error('jenis_kantor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
