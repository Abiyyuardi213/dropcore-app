...
<head>
    ...
    <style>
        ...
        .header {
            width: 100%;
            margin-bottom: 25px;
            border-bottom: 3px solid #333; /* Garis pemisah hitam tebal */
            padding-bottom: 10px;
        }
        .header .logo {
            width: 100px;
        ...
        .info-block {
            ...
            border-left: 5px solid #666; /* Garis vertikal menonjol */
            border-radius: 2px;
        ...
        .product-table th {
            background: #666; /* Header tabel abu-abu gelap */
            color: white;
            font-weight: 600;
            padding: 8px;
        ...
        .total-value {
            font-weight: bold;
            text-align: right;
            border-top: 3px solid #333; /* Garis tebal hitam di atas nilai total */
            padding-top: 5px;
            font-size: 14px;
            width: 150px;
            color: #333;
