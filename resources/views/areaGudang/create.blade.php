                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_area" class="form-control @error('kode_area') is-invalid @enderror"
                                value="{{ old('kode_area') }}" required placeholder="Contoh: A01">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_area" class="form-control @error('nama_area') is-invalid @enderror"
                                value="{{ old('nama_area') }}" required placeholder="Contoh: Area Penyimpanan Barang Jadi">
                        ...
                        <div class="form-group">
                            ...
                            <select name="area_status" class="form-control @error('area_status') is-invalid @enderror" required>
                                <option value="1" {{ old('area_status') == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('area_status') == '0' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
