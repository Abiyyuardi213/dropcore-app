                                    ...
                                    <div class="tab-pane fade show active" id="general" role="tabpanel"
                                            ...
                                            <select name="gudang_id" id="gudang_id"
                                                ...
                                                @foreach ($gudangs as $gudang)
                                                    <option value="{{ $gudang->id }}"
                                                        {{ old('gudang_id', $area->gudang_id) == $gudang->id ? 'selected' : '' }}>
                                                        {{ $gudang->nama_gudang }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kode_area"
                                                        ...
                                                        value="{{ old('kode_area', $area->kode_area) }}" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="jenis_area"
                                                        ...
                                                        <option value="Dry"
                                                            {{ old('jenis_area', $area->jenis_area) == 'Dry' ? 'selected' : '' }}>
                                                            Dry (Kering)</option>
                                                        <option value="Cold Storage"
                                                            {{ old('jenis_area', $area->jenis_area) == 'Cold Storage' ? 'selected' : '' }}>
                                                            Cold Storage (Pendingin)</option>
                                                        <option value="Dangerous Goods"
                                                            {{ old('jenis_area', $area->jenis_area) == 'Dangerous Goods' ? 'selected' : '' }}>
                                                            Bahan Berbahaya</option>
                                                        <option value="Transit"
                                                            {{ old('jenis_area', $area->jenis_area) == 'Transit' ? 'selected' : '' }}>
                                                            Transit</option>
                                                    </select>
                                                    @error('jenis_area')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="area_status"
                                                ...
                                                required>
                                                <option value="1"
                                                    {{ old('area_status', $area->area_status) == '1' ? 'selected' : '' }}>
                                                    Aktif</option>
                                                <option value="0"
                                                    {{ old('area_status', $area->area_status) == '0' ? 'selected' : '' }}>
                                    ...
                                    <div class="tab-pane fade" id="details" role="tabpanel"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kapasitas_area"
                                                        ...
                                                        value="{{ old('kapasitas_area', $area->kapasitas_area) }}"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kelembaban"
                                                        ...
                                                        value="{{ old('kelembaban', $area->kelembaban) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                                placeholder="Deskripsi detail area">{{ old('keterangan', $area->keterangan) }}</textarea>
                                            @error('keterangan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
