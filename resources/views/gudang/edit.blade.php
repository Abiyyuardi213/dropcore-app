        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ubah Data Gudang</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-edit"></i> Form Ubah Data Gudang</h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="tab-pane fade show active" id="general" role="tabpanel"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="Utama"
                                                            {{ old('jenis_gudang', $gudang->jenis_gudang) == 'Utama' ? 'selected' : '' }}>
                                                            Gudang Utama (Pusat)</option>
                                                        <option value="Cabang"
                                                            {{ old('jenis_gudang', $gudang->jenis_gudang) == 'Cabang' ? 'selected' : '' }}>
                                                            Gudang Cabang</option>
                                                        <option value="Transit"
                                                            {{ old('jenis_gudang', $gudang->jenis_gudang) == 'Transit' ? 'selected' : '' }}>
                                                            Gudang Transit</option>
                                                        <option value="Produksi"
                                                            {{ old('jenis_gudang', $gudang->jenis_gudang) == 'Produksi' ? 'selected' : '' }}>
                                                            Gudang Produksi</option>
                                                        <option value="Retur"
                                                            {{ old('jenis_gudang', $gudang->jenis_gudang) == 'Retur' ? 'selected' : '' }}>
                                                            Gudang Retur</option>
                                                    </select>
                                                    @error('jenis_gudang')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="pic" value="{{ old('pic', $gudang->pic) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('lokasi') is-invalid @enderror" name="lokasi" required
                                                placeholder="Alamat lengkap gudang" rows="2">{{ old('lokasi', $gudang->lokasi) }}</textarea>
                                            @error('lokasi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('gudang_status') is-invalid @enderror"
                                                ...
                                                <option value="1"
                                                    {{ old('gudang_status', $gudang->gudang_status) == '1' ? 'selected' : '' }}>
                                                    Aktif</option>
                                                <option value="0"
                                                    {{ old('gudang_status', $gudang->gudang_status) == '0' ? 'selected' : '' }}>
                                    ...
                                    <div class="tab-pane fade" id="details" role="tabpanel"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="luas_area"
                                                        value="{{ old('luas_area', $gudang->luas_area) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi"
                                                placeholder="Informasi tambahan mengenai gudang ini" rows="4">{{ old('deskripsi', $gudang->deskripsi) }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
