        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Manajemen Gudang</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Daftar Gudang Tersedia</h3>
                            <a href="{{ route('gudang.create') }}" class="btn btn-primary btn-sm ml-auto">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input type="checkbox" class="toggle-status"
                                                        ...
                                                        {{ $gudang->gudang_status ? 'checked' : '' }}>
                                                </td>
                                                <td class="text-center">
                                                    <a href="{{ route('gudang.edit', $gudang->id) }}" class="btn btn-info btn-sm">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <button class="btn btn-danger btn-sm delete-gudang-btn"
                                                        data-toggle="modal"
                                                        data-target="#deleteGudangModal"
                                                        data-gudang-id="{{ $gudang->id }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteGudangModalLabel"><i class="fas fa-exclamation-triangle"></i> Konfirmasi Hapus</h5>
