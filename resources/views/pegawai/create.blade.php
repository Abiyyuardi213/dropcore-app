            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-plus-circle"></i> Form Tambah Pegawai
                        </h3>
                    </div>
                        ...
                        <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- Role otomatis staff -->
                                    <input type="hidden" name="role_id" value="{{ $role_staff_id }}">
                            ...
                            <a href="{{ route('pegawai.index') }}" class="btn btn-secondary mt-4">Batal</a>
