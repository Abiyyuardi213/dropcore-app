...
<head>
    ...
    <title>Edit Jabatan - DropCore</title>
                            ...
                            <div class="card-body">
                                <div class="form-group pb-0 mb-0">
                                    ...
                                    <input type="text" name="kode_jabatan"
                                        ...
                                        value="{{ old('kode_jabatan', $jabatan->kode_jabatan) }}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="divisi_id"
                                        ...
                                        @foreach ($divisis as $div)
                                            <option value="{{ $div->id }}"
                                                {{ old('divisi_id', $jabatan->divisi_id) == $div->id ? 'selected' : '' }}>
                                                {{ $div->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('divisi_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="tanggung_jawab" class="form-control" rows="3">{{ old('tanggung_jawab', $jabatan->tanggung_jawab) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Kualifikasi</label>
                                    <textarea name="kualifikasi" class="form-control" rows="3">{{ old('kualifikasi', $jabatan->kualifikasi) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Deskripsi Tambahan</label>
                                    <textarea name="deskripsi" class="form-control" rows="2">{{ old('deskripsi', $jabatan->deskripsi) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Status</label>
                                    <select name="status" class="form-control">
                                        <option value="1" {{ $jabatan->status ? 'selected' : '' }}>Aktif</option>
                                        <option value="0" {{ !$jabatan->status ? 'selected' : '' }}>Non-Aktif
                                        </option>
                                    </select>
                                </div>
                            </div>
