...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-md-8">
                                <div class="card card-primary card-outline">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-user-plus mr-1"></i> Informasi Pengguna
                                        </h3>
                                    </div>
                                    <div class="card-body">
                                        @if (session('error'))
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Alamat</label>
                                                    <textarea class="form-control" name="alamat" rows="1" placeholder="Alamat lengkap">{{ old('alamat') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status_kepegawaian" class="form-control">
                                                <option value="aktif"
                                                    {{ old('status_kepegawaian') == 'aktif' ? 'selected' : '' }}>Aktif
                                                </option>
                                                <option value="nonaktif"
                                                    {{ old('status_kepegawaian') == 'nonaktif' ? 'selected' : '' }}>
                                                    Nonaktif</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-warning card-outline">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="image-preview-container mb-3"
                                            ...
                                            <img id="preview" src="{{ asset('image/default-user.png') }}"
                                                alt="Preview"
                                        ...
                                        <div class="custom-file text-left">
                                            ...
                                            <label class="custom-file-label" for="profile_picture">Pilih
                                                file...</label>
                                        </div>
    ...
    <script>
        ...
        input.addEventListener('change', (e) => {
            ...
            if (!file) {
                // If user cancels, we might want to reset? 
                // Better to keep existing if available, or reset to default if not.
                return;
            }
