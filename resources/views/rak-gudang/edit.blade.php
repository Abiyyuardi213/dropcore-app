            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="gudang_id" id="gudang_id" class="form-control @error('gudang_id') is-invalid @enderror" required>
                                ...
                                @foreach($gudangs as $gudang)
                                    <option value="{{ $gudang->id }}" {{ old('gudang_id', $rak->gudang_id) == $gudang->id ? 'selected' : '' }}>
                                        {{ $gudang->nama_gudang }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="area_id" id="area_id" class="form-control @error('area_id') is-invalid @enderror" required>
                                ...
                                @foreach($areas as $area)
                                    <option value="{{ $area->id }}" {{ old('area_id', $rak->area_id) == $area->id ? 'selected' : '' }}>
                                        {{ $area->kode_area }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <label for="kode_rak">Kode Area</label>
                            <input type="text" name="kode_rak" class="form-control @error('kode_rak') is-invalid @enderror"
                                value="{{ old('kode_rak', $rak->kode_rak) }}" required placeholder="Contoh: A01">
                        ...
                        <div class="form-group">
                            ...
                            <select name="rak_status" class="form-control @error('area_status') is-invalid @enderror" required>
                                <option value="1" {{ old('rak_status', $rak->rak_status) == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('rak_status', $rak->rak_status) == '0' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
