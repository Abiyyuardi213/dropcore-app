        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Rak Gudang</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-edit"></i> Form Edit Rak Gudang</h3>
                        </div>
                        <div class="card-body">
                            @if (session('error'))
                            ...
                            <form action="{{ route('rak-gudang.update', $rak->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="tab-pane fade show active" id="general" role="tabpanel"
                                                    ...
                                                    <select name="gudang_id" id="gudang_id"
                                                        ...
                                                        @foreach ($gudangs as $gudang)
                                                            <option value="{{ $gudang->id }}"
                                                                {{ old('gudang_id', $rak->gudang_id) == $gudang->id ? 'selected' : '' }}>
                                                                {{ $gudang->nama_gudang }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select name="area_id" id="area_id"
                                                        ...
                                                        @foreach ($areas as $area)
                                                            <option value="{{ $area->id }}"
                                                                {{ old('area_id', $rak->area_id) == $area->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kode_rak"
                                                        ...
                                                        value="{{ old('kode_rak', $rak->kode_rak) }}" required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="rak_status"
                                                ...
                                                required>
                                                <option value="1"
                                                    {{ old('rak_status', $rak->rak_status) == '1' ? 'selected' : '' }}>
                                                    Aktif</option>
                                                <option value="0"
                                                    {{ old('rak_status', $rak->rak_status) == '0' ? 'selected' : '' }}>
                                                    Nonaktif (Maintenance)</option>
                                            </select>
                                            @error('rak_status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="tab-pane fade" id="details" role="tabpanel"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="jenis_rak"
                                                        ...
                                                        <option value="Heavy Duty"
                                                            {{ old('jenis_rak', $rak->jenis_rak) == 'Heavy Duty' ? 'selected' : '' }}>
                                                            Heavy Duty</option>
                                                        <option value="Medium Duty"
                                                            {{ old('jenis_rak', $rak->jenis_rak) == 'Medium Duty' ? 'selected' : '' }}>
                                                            Medium Duty</option>
                                                        <option value="Light Duty"
                                                            {{ old('jenis_rak', $rak->jenis_rak) == 'Light Duty' ? 'selected' : '' }}>
                                                            Light Duty</option>
                                                        <option value="Pallet Racking"
                                                            {{ old('jenis_rak', $rak->jenis_rak) == 'Pallet Racking' ? 'selected' : '' }}>
                                                            Pallet Racking</option>
                                                        <option value="Cantilever"
                                                            {{ old('jenis_rak', $rak->jenis_rak) == 'Cantilever' ? 'selected' : '' }}>
                                                            Cantilever</option>
                                                    </select>
                                                    @error('jenis_rak')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bahan_rak"
                                                        ...
                                                        value="{{ old('bahan_rak', $rak->bahan_rak) }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kapasitas_max"
                                                        ...
                                                        value="{{ old('kapasitas_max', $rak->kapasitas_max) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                                placeholder="Deskripsi kondiri rak atau catatan lainnya">{{ old('keterangan', $rak->keterangan) }}</textarea>
                                            @error('keterangan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-save"></i> Perbarui Rak
                                    </button>
