                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="d-flex align-items-center mt-1">
                                                    <div class="custom-control custom-radio mr-4">
                                                        <input type="radio" id="asal_dalam_negeri" name="asal_supplier" value="dalam_negeri" class="custom-control-input" {{ old('asal_supplier', 'dalam_negeri') == 'dalam_negeri' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="asal_luar_negeri" name="asal_supplier" value="luar_negeri" class="custom-control-input" {{ old('asal_supplier') == 'luar_negeri' ? 'checked' : '' }}>
