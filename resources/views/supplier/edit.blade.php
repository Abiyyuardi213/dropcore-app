                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="keterangan" class="form-control" rows="4">{{ old('keterangan', $supplier->keterangan) }}</textarea>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('penanggung_jawab', $supplier->penanggung_jawab) }}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select name="wilayah_id" id="wilayah_id"
                                                        ...
                                                        @foreach ($wilayahs as $wilayah)
                                                            <option value="{{ $wilayah->id }}"
                                                                {{ old('wilayah_id', $supplier->wilayah_id) == $wilayah->id ? 'selected' : '' }}>
                                                    ...
                                                    <select name="provinsi_id" id="provinsi_id"
                                                        ...
                                                        @foreach ($provinsis as $provinsi)
                                                            <option value="{{ $provinsi->id }}"
                                                                {{ old('provinsi_id', $supplier->provinsi_id) == $provinsi->id ? 'selected' : '' }}>
