                ...
                <div class="container-fluid">
                    <div class="card card-warning card-outline">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-edit mr-1"></i> Form Edit Distributor
                            </h3>
                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="nama_distributor"
                                                                    ...
                                                                    required placeholder="Contoh: PT. Maju Jaya"
                                                                    autocomplete="off">
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="tipe_distributor"
                                                                ...
                                                                <option value="Distributor"
                                                                    {{ old('tipe_distributor', $distributor->tipe_distributor) == 'Distributor' ? 'selected' : '' }}>
                                                                    Distributor</option>
                                                                <option value="Principal"
                                                                    {{ old('tipe_distributor', $distributor->tipe_distributor) == 'Principal' ? 'selected' : '' }}>
                                                                    Principal</option>
                                                                <option value="Reseller"
                                                                    {{ old('tipe_distributor', $distributor->tipe_distributor) == 'Reseller' ? 'selected' : '' }}>
                                                                    Reseller</option>
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status"
                                                                ...
                                                                <option value="blacklisted"
                                                                    {{ old('status', $distributor->status) == 'blacklisted' ? 'selected' : '' }}>
                                                                    Blacklisted</option>
                                                            </select>
                                                            @error('status')
                                                                <span
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <textarea name="alamat" rows="4" class="form-control @error('alamat') is-invalid @enderror"
                                                                    placeholder="Jalan, No. Gedung, RT/RW, dsb">{{ old('alamat', $distributor->alamat) }}</textarea>
                                                            </div>
                                                            @error('alamat')
                                                                <span
                                                                    class="text-danger text-sm">{{ $message }}</span>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="pic_nama"
                                                                            ...
                                                                            value="{{ old('pic_nama', $distributor->pic_nama) }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="pic_telepon"
                                                                            ...
                                                                            value="{{ old('pic_telepon', $distributor->pic_telepon) }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <textarea name="keterangan" rows="2" class="form-control @error('keterangan') is-invalid @enderror"
                                                                    placeholder="Catatan khusus...">{{ old('keterangan', $distributor->keterangan) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
