                        ...
                        <form action="{{ route('stok.update', $stok->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="area_id" id="area_id" class="form-control @error('area_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($areas as $area)
                                        <option value="{{ $area->id }}" {{ old('area_id', $stok->area_id) == $area->id ? 'selected' : '' }}>
                                            {{ $area->kode_area }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="rak_id" id="rak_id" class="form-control @error('rak_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($raks as $rak)
                                        <option value="{{ $rak->id }}" {{ old('rak_id', $stok->rak_id) == $rak->id ? 'selected' : '' }}>
                                            {{ $rak->kode_rak }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity', $stok->quantity) }}">
